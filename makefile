...
run-encrypt:
	go run app/tle/main.go -n="http://pl-us.testnet.drand.sh/" -c="7672797f548f3f4748ac4bf3352fc6c6b6468c9ad40ad456a397545c6e2df5bf" -D=30s -o=encryptedFile.txt makefile

run-decrypt:
	go run app/tle/main.go -d -n="http://pl-us.testnet.drand.sh/" -o=decryptedFile.txt encryptedFile.txt
